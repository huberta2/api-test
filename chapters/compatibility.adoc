...
1.API versioning {SHOULD} be done using the URI versioning mechanism (e.g. /api/v1/wells).
2.API versions {SHOULD} be written in the form vN with N being an integer (e.g. /api/v3/wells).
